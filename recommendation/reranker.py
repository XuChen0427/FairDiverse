...
from .rerank_model import CPFair, FairRec, FairRecPlus, k_neighbor, min_regularizer, PMMF, Welf, TaxRank, ConcaveRank
from .metric import dcg, MMF, Gini, Entropy
...
class RecReRanker(object):
    ...
    def rerank(self):
        ...
        elif config['model'] == 'ConcaveRank':
            Reranker = ConcaveRank(config)
        else:
